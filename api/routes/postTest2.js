...
process.on('SIGINT', function() {
    pool.end();
    console.log('\npostTest2 pool successfully shut down');
    process.exit(0);
});
...
router.post('/', (req, res) => {
    ...
    // let names = req.body.names.substring(1, req.body.names.length - 1);
    // names = '(' + names + ')';
    // let values = req.body.values.substring(1, req.body.values.length - 1);
    // values = '(' + values + ')';
